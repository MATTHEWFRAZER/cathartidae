...
decorators      = [
                  if_, dynamic_if, with_, dynamic_with, while_, while_generator, dynamic_while, dynamic_while_generator,
...
class TestDecoratorsAgainstDifferentFunctions:
    ...
    @pytest.mark.parametrize("decorator", [while_, while_generator])
    def test_while_decorators_dynamic_application(self, decorator): pass
